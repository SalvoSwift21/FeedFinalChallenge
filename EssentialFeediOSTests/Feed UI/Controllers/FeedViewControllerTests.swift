...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore(){
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected two cancelled image URL requests once second image is also not visible anvmore")
    ...
    private func assertThat (_ sut: FeedViewController, isRendering feed: [FeedImage], file: StaticString = #file,
                             line: UInt = #line) {
